...
from .configure import jm_single, get_p2pk_vbyte
from .enc_wrapper import init_keypair, as_init_encryption, init_pubkey, \
     NaclError
from .support import get_log, calc_cj_fee
from .wallet import estimate_tx_fee
from .irc import B_PER_SEC
from .blockchaininterface import ElectrumWalletInterface
import btc
...
class CoinJoinTX(object):
    ...
    def self_sign_and_push(self):
        log.debug("Call self sign")
        self.self_sign()
        log.debug("Call self push")
        return self.push()
