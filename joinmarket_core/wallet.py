...
from .blockchaininterface import BitcoinCoreInterface, ElectrumWalletInterface
from .configure import jm_single, get_network, get_p2pk_vbyte

from .support import get_log, select_gradual, select_greedy, \
...
class ElectrumWrapWallet(AbstractWallet):
    ...
    def get_internal_addr(self, mixdepth):
        ...
        try:
            ...
            log.debug("Failed get addresses: " + repr(e))
            raise
        #filter by unused
        try:
